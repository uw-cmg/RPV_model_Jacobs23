...
def rebuild_model(n_features, model_folder):
    ...
    for i in range(num_models):
        models.append(tf.keras.models.load_model(os.path.join('RPV_model_Jacobs23/'+model_folder, 'keras_model_' + str(i))))
...
def make_predictions_DNN(df_featurized, model_folder):
    ...
    preprocessor = joblib.load(os.path.join('RPV_model_Jacobs23/'+model_folder, 'StandardScaler.pkl'))
